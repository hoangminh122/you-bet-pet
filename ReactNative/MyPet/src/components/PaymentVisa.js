                 ...
                 <View style={[styles.body,{width:screen.width}]}>
                    ...
                    <FlatList
                        ...
                        <View style={[styles.bodyTop10Object,{height:screen.height/8}]} key={{index}}>
                            ...
                            <View>
                                <Text style={styles.bodyTop10ObjectInforTxt}>Thẻ tín dụng/ ghi nợ</Text>
                            </View>
                            </View>
                        </View>
                        } 
                    ...
                    <FlatList
                        ...
                        <View style={[styles.bodyTop10Object,{height:screen.height/3,flexDirection:'column'}]} key={{index}}>
                            <View style={{flex:1,height:'100%'}}>
                                ...
                                <TextInput type="text" placeholder="so the" style={{borderWidth:1,borderColor:'gray',height:'60%',margin:5}}/>
                            </View>
                            <View style={{flex:1}}>
                                <Text style={{fontWeight:'bold',marginLeft:5}}>Tên chủ thẻ</Text>
                                <TextInput type="text" placeholder="ten chu the" style={{borderWidth:1,borderColor:'gray',height:'60%',margin:5}}/>
                            </View>
                            <View style={{flex:1,flexDirection:'row'}}>
                                <View style={{flex:1}}>
                                    <Text style={[styles.bodyTop10ObjectInforTxt,{marginLeft:10}]}>Ngày hết hạn</Text>
                                    <TextInput  type="text" placeholder="mm/yy" style={{borderWidth:1,borderColor:'gray',height:'60%',margin:5}}/>
                                </View>
                                <View style={{flex:1}}>
